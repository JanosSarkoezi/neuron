...
public final class Validators {
    ...
    public static <T, U> Validator<T> nested(
        Function<T, U> extractor, Validator<U> validator, String nullMessage) {
        return t -> {
     ...
     */
    public static <T, U> Validator<T> notNull(
        Function<T, U> getter, String errorMessage) {
     ...
     */
    public static <A> Validator<List<A>> validateAllElements(
